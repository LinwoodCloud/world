...
export (int) var voxel_texture_size = 256;
...
export (int) var voxel_texture_tile_size = 64;
...
func set_world_voxel(position, voxel):
	...
	# If you want, you can check to see if a voxel was placed or not using the code below:
	"""
	if (result == true):
